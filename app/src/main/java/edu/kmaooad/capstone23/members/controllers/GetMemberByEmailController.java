...
@APIResponse(responseCode = "200", content = {
        @Content(mediaType = "application/json", schema = @Schema(implementation = MemberRead.class))})
public class GetMemberByEmailController extends TypicalController<GetMemberByEmail, MemberRead> {
}
