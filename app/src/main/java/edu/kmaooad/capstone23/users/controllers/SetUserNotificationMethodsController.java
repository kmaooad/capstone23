...
@Path("/users/set-notification-methods")
@APIResponse(responseCode = "200", content = {
        @Content(mediaType = "application/json", schema = @Schema(implementation = UserNotificationMethodsSetted.class))})
public class SetUserNotificationMethodsController extends TypicalController<SetUserNotificationMethods, UserNotificationMethodsSetted> {
}